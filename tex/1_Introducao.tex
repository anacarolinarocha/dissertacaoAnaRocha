...
\myworries{aqui, como queria uma definição bem simples pra processo, eu citei a wiki. mas pergunto se isso é um problema.... eventualmente, poderia apenas remover a fonte?}
\gnramos{Sim, wikipedia não é uma fonte de informação acadêmica (provavelmente lá há referência para uma)}
...
\myworries{//TODO: confirmar o numero de assuntos}
...
\gnramos{o que é "baixa"? e "qualidade"?}
...
\myworries{//TODO: verificar se o assunto influenciaria na distribuição…. Entra na competencia? - JÁ PERGUNTEI AO RÔMULO}
...
\gnramos{qual o objetivo da pesquisa?}

\myworries{//TODO: vai reduzir a quantidade de assuntos?}
...
\gnramos{potencial utilização não é objetivo.}
\end{enumerate}

\myworries{//DÚVIDA: o último está correto?}

\myworries{//DÚVIDA: preciso especificar aqui que é um problema de classificação multi-label?}
...
\gnramos{"2o grau" ou "segundo grau"?}
...
\gnramos{use \textbackslash{ref} para referenciar outras coisas. A dissertação é dividida em capítulos.}
