...
\gnramos{li apenas a parte marcada com "dúvida"}%
...
\gnramos{não diga. não é referência bibliográfica, apenas indique o sítio como nota de rodapé.}
...
\gnramos{talvez. mas é mais importante apresentar algo fechado para qualificação que se preocupar muito com isso. Não são necessários muitos detalhes dos algoritmos.}
